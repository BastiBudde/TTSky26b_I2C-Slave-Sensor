...
**Validated by:** [VAL-001](validation.md#val-001)  
...
**Validated by:** [VAL-002](validation.md#val-002)  
...
**Verified by:** Implicitly covered by [TC-001](verification_report.md#TC-001)
...
**Validated by:** [VAL-004](validation.md#val-004)  
...
**Validated by:** [VAL-006](validation.md#val-006)  
**Verified by:** [TC-001](verification_report.md#TC-001), [TC-002](verification_report.md#TC-002), [TC-004](verification_report.md#TC-004)

### REQ-007: Clock speed range
<a name="req-007"></a>
The slave shall be able to operate at the three standard I2C bus speeds: Standard Mode (100 kHz), Fast Mode (400 kHz), and Fast Mode Plus (1 MHz), given a system clock of 25 MHz.   
**Validated by:** [VAL-007](validation.md#val-007)  
...
**Validated by:** [VAL-010](validation.md#val-010)  
...
**Validated by:** [VAL-011](validation.md#val-011)  
...
<a name="req-014"></a>
A read transaction from an unmapped register address shall return 0x00.  
...
**Validated by:** [VAL-016](validation.md#val-016)  
...
**Validated by:** [VAL-017](validation.md#val-017)  
...
**Validated by:** [VAL-018](validation.md#val-018)  
